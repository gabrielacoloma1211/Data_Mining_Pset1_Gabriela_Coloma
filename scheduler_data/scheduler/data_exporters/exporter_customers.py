...
def export_customers(data, *args, **kwargs):
    """
    Inserta registros en la tabla raw.qb_customers en Postgres con UPSERT (idempotente).
    ...
    # upsert para idempotencia osea si no hay inserta y si sí hay actualiza
    for row in rows:
        cursor.execute("""
