...
def load_data(*args, **kwargs):
    ...
    while current_start < fecha_fin_dt:
        ...
        while True:
            ...
            customers = data.get("QueryResponse", {}).get("Customer", [])
            if not customers:  #si ya no hay más resultados
                break
